...
![Arquitetura](https://github.com/matheusbudin/big-data-airlines/blob/development/assets_for_readme/arquitetura_png.png)
...
```
![Snake_case_base_VRA](https://github.com/matheusbudin/big-data-airlines/blob/development/assets_for_readme/vra_snake_case.png)
...
```
Resultando na transformação desejada para as colunas:

![task1_transformação_final](https://github.com/matheusbudin/big-data-airlines/blob/development/assets_for_readme/vra_snake_case_final.png)

O arquivo salvo após estas transformações pode ser encontrado no link a seguir: [VRA_tratado_exportado](https://github.com/matheusbudin/big-data-airlines/blob/development/converted_data/VRA/parquet_format/vra_encoded.parquet)
...
```
(a print não contempla todas as colunas, caso seja necessário, favor consultar no notebook para esta task)
![task2_snake_case_e_slicing](https://github.com/matheusbudin/big-data-airlines/blob/development/assets_for_readme/AIR_CIA_final.png)


Após os tratamentos, o arquivo referente aos dados da base AIR_CIA está localizado na pasta: [AIR_CIA_export](https://github.com/matheusbudin/big-data-airlines/tree/development/converted_data/AIR_CIA)
...
```
![dataframe_dados_extraido_API](https://github.com/matheusbudin/big-data-airlines/blob/development/assets_for_readme/api.png)
...
![View_Rota_Mais_Utilizada_por_cia](https://github.com/matheusbudin/big-data-airlines/blob/development/assets_for_readme/View1_distinct.png)
